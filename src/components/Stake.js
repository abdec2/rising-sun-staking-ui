    ...
    return (
        <>
            <section className="stake-and-earn-connected wf-section">
                <h2 data-w-id="638e3a75-1253-8367-0636-0a1cb9fe5d04" style="-webkit-transform:translate3d(0, 100px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(3deg) skew(0, 0);-moz-transform:translate3d(0, 100px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(3deg) skew(0, 0);-ms-transform:translate3d(0, 100px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(3deg) skew(0, 0);transform:translate3d(0, 100px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(3deg) skew(0, 0);opacity:0" className="main-title connected">STAKE and earn</h2>
                ...
                <div className="stake-nfts">
                    <div className="nft-row">
                        ...
                        <div data-w-id="53fe16d8-ef1f-9785-4265-b01dfddb28f7" className="nft-image"><img src="images/image-mint-placeholder.jpg" loading="lazy" style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0deg) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0deg) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0deg) rotateZ(0) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0deg) rotateZ(0) skew(0, 0);transform-style:preserve-3d;opacity:1" alt="" className="image-nft-stake"><img src="images/image-stake-coffin.png" loading="lazy" style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0deg) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0deg) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0deg) rotateZ(0) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0deg) rotateZ(0) skew(0, 0);transform-style:preserve-3d;opacity:0" alt="" className="image-coffin"></div>
                            <div className="nft-id">#7480</div>
                            <div className="white-detail-line"></div>
                        </div>
                        <div className="nft-row">
                            <div className="check-box-holder"><img src="images/tick.svg" loading="lazy" alt="" className="image-tick"/></div>
                            <div className="nft-image"><img src="images/image-mint-placeholder.jpg" loading="lazy" width="76" alt=""/></div>
                            <div className="nft-id">#7480</div>
                            <div className="white-detail-line"></div>
                        </div>
            ...
            <footer data-w-id="1c6363c1-60a3-5681-8671-51603099bdca" style="opacity:0" className="footer stake wf-section">
                ...
                {/* <div className="container footer-mobile w-container">
                    ...
                    <div className="footer-madeby">
                        <p className="typo-footer dark">Website by</p>
                        <a href="https://www.dearfuture.agency/" target="_blank" className="footer-link typo-footer">dear future</a>
                    </div>
                </div> */}
            </footer>
